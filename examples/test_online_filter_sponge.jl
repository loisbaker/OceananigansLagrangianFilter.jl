...
filename_stem = "test_sponge_online";
...
# Define a spatial mask (mask_params can be nothing but the arg should be there anyway)
mask_func(x,z,p) = 1
...
# sponge_forcing = (b = b_Forcing,)# ### Add these to the existing forcing
