...
filename_stem = "data/SW_IO_with_tracer";

# ### Define the grid

grid = RectilinearGrid(GPU(), size = (200, 200),
                       x = (0, 2*pi),
                       y = (0, 2*pi),
...
filter_config = OfflineFilterConfig(original_data_filename="data/SW_IO_with_tracer.jld2", # Where the original simulation output is
                                    output_filename = "data/SW_IO_with_tracer_filtered.jld2", # Where to save the filtered output
